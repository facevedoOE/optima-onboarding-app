...
const formDefinitions = [
  ...
  },
  {
    ...
    description: 'Certification details for instructional staff — complete the embedded Microsoft Form below.',
    appliesTo: 'oao',
    version: 2,
    formType: 'Microsoft Form',
    // EMBED the real Microsoft Form (response page).
    type: 'embed',
    embedUrl: 'https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=lf6yxwVTQ0GkJSYr0O1tXgbEKHRwkb9IqUhz0CLWIctUQkNCVFA3Q0tJR0ZBRlAyT0pKTEVKOUhZMi4u&embed=true',
    fields: [],
  },
  {
    id: 'i9-meeting',
