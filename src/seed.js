...
const formDefinitions = [
  ...
  },
  {
    ...
    description: 'Florida Clearinghouse / charter background screening authorization.',
    appliesTo: 'oao',
    version: 1,
    fields: [
      { key: 'charterSchool', label: 'Charter School Name', type: 'select', required: true,
        options: ['9040 - Optima Classical Academy (OCA)'], help: 'Select OCA unless directed otherwise.' },
      { key: 'legalFirstName', label: 'Legal First Name', type: 'text', required: true },
      { key: 'legalLastName', label: 'Legal Last Name', type: 'text', required: true },
      { key: 'dob', label: 'Date of Birth', type: 'date', required: true },
      { key: 'ssnLast4', label: 'SSN (last 4)', type: 'text', required: true, placeholder: '••••' },
      { key: 'positionApplied', label: 'Position', type: 'text', required: true },
      { key: 'authorize', label: 'I authorize the background screening described above.', type: 'attestation', required: true },
    ],
  },
  {
    id: 'ccps-charter',
    key: 'ccps-charter',
    title: 'CCPS — Charter School Employee',
    description: 'Charter school new employee form (full-time).',
    appliesTo: 'oao-fulltime',
    version: 2, // bumped — the new CCPS revision
    fields: [
      { key: 'charterSchool', label: 'Charter School Name', type: 'select', required: true,
      ...
      { key: 'position', label: 'Position', type: 'text', required: true },
      { key: 'startDate', label: 'Start Date', type: 'date', required: true },
      { key: 'certHeld', label: 'Florida Certification Held?', type: 'select', options: ['Yes', 'No', 'Pending'] },
